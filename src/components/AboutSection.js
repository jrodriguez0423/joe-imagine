  ...
  <div className="info-section py-5">
    <Container>
      <Row className="info-row mb-4">
        <Col md={12} lg={6}>
          <Card className="h-100">
            <Card.Body>
              <Card.Title className='about-head'>Our Story</Card.Title>
              <Card.Text>
      ...
      <Row className="info-row">
        <Col md={12} lg={6} className="order-2 order-lg-1 img-card">
          <Card className="h-100">
        ...
        <Col md={12} lg={6} className="order-1 order-lg-2">
          <Card className="h-100">
            <Card.Body>
              <Card.Title className='about-head'>Core Values</Card.Title>
              <Card.Text>
                ...
                Community: We foster a sense of belonging and family among our residents, staff, and the wider community.
                Innovation: We embrace new ideas and approaches to improve the quality of life for our residents.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
